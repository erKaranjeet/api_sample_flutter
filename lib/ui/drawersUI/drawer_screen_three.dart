...
class DrawerScreenThree extends StatefulWidget {
  @override
  DrawerScreenThreeState createState() => DrawerScreenThreeState();
}

class DrawerScreenThreeState extends State<DrawerScreenThree> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Drawer Screen Three"),
        backgroundColor: Colors.black,
        actions: [
          IconButton(
